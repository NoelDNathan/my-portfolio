...
export const timelineItems: TimelineItem[] = [
  ...
  },
  {
    ...
    shortSkills: ["Unity", "C#", "Blender", "Game Design", "Photoshop", "Programming"],
    topic: "project",
    video: {
  ...
  },
  {
    ...
    shortSkills: ["Python", "Machine Learning", "Geospatial", "Data Viz", "Azure", "ArcGIS", "Unity", "C#", "Pandas"],
    topic: "professional",
    video: null,
  },
  {
    ...
    shortSkills: ["LLMs", "Prompting", "Azure", "APIs", "React", "Python", "LangChain", "LangGraph", "Gantt", "PERT", "Risk Assessment", "Agile", "Teamwork"],
    topic: "project",
    video: {
  ...
  },
  {
    ...
    shortSkills: ["ZK Proofs", "Cryptography", "Information Retrieval", "Explainable ML", "English", "Automated ML"],
    topic: "education",
    video: null,
    links: [
      {
  ...
  },
  {
    ...
    shortSkills: ["Solidity", "Circom", "Rust", "React", "Hardhat", "Testing", "Cryptography", "Blockchain", "P2P Networking", "Smart Contracts", "Smart Wallets", "ERC-20", "ERC-721"],
    topic: "project",
    video: {
  ...
  },
  {
    ...
    shortSkills: ["Python", "Computer Vision", "Reinforcement Learning", "MATLAB", "Robotics", "YOLO", "Data Augmentation", "DQN", "PPO", "Pick and Place", "Collaborative Robots", "Universal Robots"],
    topic: "professional",
    video: {
  ...
  },
  {
    ...
    shortSkills: ["Universal Robots", "Robot Programming", "Safety Config", "Motion Planning", "Collaborative Robots", "Pick and Place"],
    topic: "course",
    video: null,
  },
  {
  ...
  },
  {
    ...
    shortSkills: ["LLMs", "Transformers", "training", "Web Inference"],
    topic: "project",
    video: null,
  },
  {
    ...
    shortSkills: ["OR-Tools", "React", "FastAPI", "AWS", "Docker", "CI/CD", "SQLAlchemy", "PostgreSQL", "Python", "JavaScript", "Git", "Teamwork", "Leadership", "Communication", "Problem Solving", "Critical Thinking", "Creativity", "Adaptability", "Resilience", "Time Management"],
    topic: "professional",
    video: {
  ...
  },
  {
    ...
    shortSkills: ["Voice AI", "Playwright", "Tooling", "Conversation Design", "Pipecat", "Python"],
    topic: "project",
    video: {
